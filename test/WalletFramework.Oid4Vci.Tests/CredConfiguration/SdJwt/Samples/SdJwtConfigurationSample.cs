...
namespace WalletFramework.Oid4Vci.Tests.CredConfiguration.SdJwt.Samples;

public static class SdJwtConfigurationSample
{
    public static CredentialFormat Format => CredentialFormat
        .ValidCredentialFormat(CredentialFormatConstants.SdJwtDcFormat)
    ...
    public static JObject ValidSample => new()
    {
        ["format"] = Format.ToString(),
        ["scope"] = Scope.ToString(),
        ["cryptographic_binding_methods_supported"] = new JArray { "jwk" },
        ["credential_signing_alg_values_supported"] = new JArray { "ES256" },
        ["proof_types_supported"] = new JObject
        {
            {
                "jwt", new JObject
                {
                    ["proof_signing_alg_values_supported"] = new JArray { "ES256" }
                }
            }
        },
        ["credential_metadata"] = new JObject
        {
            ["display"] = new JArray
            {
                new JObject
