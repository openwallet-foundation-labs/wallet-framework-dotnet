...
using static WalletFramework.Oid4Vci.CredConfiguration.Models.Mdoc.CryptographicCurve;
using static WalletFramework.Oid4Vci.CredConfiguration.Models.Mdoc.CryptographicSuite;
using static WalletFramework.Oid4Vci.CredConfiguration.Models.Mdoc.ElementDisplay;
using static WalletFramework.Oid4Vci.CredConfiguration.Models.Mdoc.ElementName;
using static WalletFramework.MdocLib.DocType;
using static WalletFramework.MdocLib.NameSpace;
using static WalletFramework.Credentials.CredentialFormat;

namespace WalletFramework.Oid4Vci.Tests.CredConfiguration.Mdoc.Samples;
...
public static class MdocConfigurationSample
{
    ...
    public static CredentialFormat Format => ValidCredentialFormat(CredentialFormatConstants.MdocFormat).UnwrapOrThrow(new InvalidOperationException());
