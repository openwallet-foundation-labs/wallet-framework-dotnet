...
{
    private readonly DefaultSdJwtVcHolderService _service;
    ...
    public SdJwtVcHolderServiceTests()
    {
        ...
        _service = new DefaultSdJwtVcHolderService(holder, keyStoreMock, walletRecordServiceMock);
    }
    ...
    public async Task Can_Create_Presentation_For_Example_4A()
    {
        ...
        // Arrange
        var sdJwtRecord = new SdJwtRecord(issuedSdJwt, new Dictionary<string, ClaimMetadata>(), new List<CredentialDisplayMetadata>(), new Dictionary<string, string>(), "0");
