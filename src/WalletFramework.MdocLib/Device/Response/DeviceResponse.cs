...
public static class DeviceResponseFun
{
    ...
    public static CBORObject AsCbor(this DeviceResponse deviceResponse)
    {
    ...
    public static Base64UrlString EncodeBase64Url(this DeviceResponse deviceResponse)
    {
        var bytes = deviceResponse.AsCbor().EncodeToBytes();
        return ValidBase64UrlString(bytes).UnwrapOrThrow();
    }
}
