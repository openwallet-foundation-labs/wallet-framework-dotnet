    ...
    public record AuthorizationRequest
    {
        ...
        private static bool IsHaipConform(JObject authorizationRequestJson)
        {
            ...
            return
                ...
                && redirectUri is null
                && (clientIdScheme is ClientIdScheme.X509SanDnsScheme or ClientIdScheme.VerifierAttestationScheme
                    || (clientIdScheme is ClientIdScheme.RedirectUriScheme && clientId == responseUri));
        }
    }
