...
using WalletFramework.Oid4Vci.CredConfiguration.Models.SdJwt;
...
using WalletFramework.Oid4Vci.Models.Metadata.Issuer;
using static WalletFramework.Core.Functional.ValidationFun;
using static WalletFramework.Oid4Vci.Authorization.Models.AuthorizationServerId;
using static WalletFramework.Oid4Vci.Issuer.Models.CredentialIssuerId;
using static WalletFramework.Oid4Vci.CredOffer.Models.CredentialConfigurationId;
using static WalletFramework.Oid4Vci.Models.Metadata.Issuer.IssuerDisplay;
using static WalletFramework.Oid4Vci.Issuer.Models.IssuerMetadataJsonExtensions;
using static WalletFramework.Oid4Vci.Models.Metadata.Issuer.BatchCredentialIssuance;
