...
using static WalletFramework.Oid4Vci.CredConfiguration.Models.Scope;
using static WalletFramework.Oid4Vci.CredConfiguration.Models.CryptographicBindingMethod;
using static WalletFramework.Oid4Vci.CredConfiguration.Models.CryptograhicSigningAlgValue;
using static WalletFramework.Oid4Vci.CredConfiguration.Models.ProofTypeId;
using static WalletFramework.Oid4Vci.CredConfiguration.Models.ProofTypeMetadata;
using static WalletFramework.Oid4Vci.CredConfiguration.Models.CredentialConfigurationFun;
using static WalletFramework.Oid4Vci.CredConfiguration.Models.CredentialMetadata;

namespace WalletFramework.Oid4Vci.CredConfiguration.Models;
...
public record CredentialConfiguration
{
    ...
    /// </summary>
    public CredentialFormat Format { get; }
    ...
    public static Validation<CredentialConfiguration> ValidCredentialConfiguration(JToken credentialMetadata, Func<JToken, Validation<ClaimPath>> claimPathValidation)
    {
        ...
        return Valid(Create)
            .Apply(credentialMetadata.GetByKey(FormatJsonKey).OnSuccess(CredentialFormat.ValidCredentialFormat))
