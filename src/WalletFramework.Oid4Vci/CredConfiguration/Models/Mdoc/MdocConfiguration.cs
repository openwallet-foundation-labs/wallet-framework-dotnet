...
using static WalletFramework.Oid4Vci.CredConfiguration.Models.Mdoc.Policy;
using static WalletFramework.Oid4Vci.CredConfiguration.Models.Mdoc.MdocConfigurationFun;

namespace WalletFramework.Oid4Vci.CredConfiguration.Models.Mdoc;
...
public record MdocConfiguration
{
    ...
    public CredentialFormat Format => CredentialConfiguration.Format;
