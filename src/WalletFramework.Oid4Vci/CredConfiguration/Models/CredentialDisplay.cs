...
using static WalletFramework.Oid4Vci.CredConfiguration.Models.CredentialName;
using static WalletFramework.Core.Localization.Locale;
using static WalletFramework.Oid4Vci.CredConfiguration.Models.CredentialLogo;
using static WalletFramework.Oid4Vci.CredConfiguration.Models.CredentialBackgroundImage;
using static WalletFramework.Oid4Vci.CredConfiguration.Models.CredentialDisplayFun;
