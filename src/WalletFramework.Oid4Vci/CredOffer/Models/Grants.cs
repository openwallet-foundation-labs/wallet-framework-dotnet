...
using WalletFramework.Oid4Vci.CredOffer.GrantTypes;
using static WalletFramework.Oid4Vci.CredOffer.GrantTypes.AuthorizationCode;
using static WalletFramework.Oid4Vci.CredOffer.GrantTypes.PreAuthorizedCode;
