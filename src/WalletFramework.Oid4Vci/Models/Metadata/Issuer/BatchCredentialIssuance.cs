...
using static WalletFramework.Oid4Vci.Models.Metadata.Issuer.BatchCredentialIssuanceFun;
using static WalletFramework.Oid4Vci.Models.Metadata.Issuer.BatchSize;
