...
using static WalletFramework.Oid4Vp.Dcql.CredentialQueries.CredentialQueryConstants;

namespace WalletFramework.Oid4Vp.Dcql.CredentialQueries;
...
public static class CredentialQueryFun
{
    public static OneOf<Vct, DocType> GetRequestedCredentialType(this CredentialQuery credentialQuery) => 
        ...
        {
            CredentialFormatConstants.SdJwtVcFormat or CredentialFormatConstants.SdJwtDcFormat 
