...
using static WalletFramework.Oid4Vp.Dcql.Models.ClaimQueryConstants;

namespace WalletFramework.Oid4Vp.Dcql.Models;
...
public static class ClaimQueryFun
{
    ...
    public static IReadOnlyList<string> AsStrings(this IEnumerable<ClaimQuery> claims, string format)
    {
        switch (format)
        {
            case CredentialFormatConstants.SdJwtVcFormat:
            case CredentialFormatConstants.SdJwtDcFormat:
                var resultSdJwt =
                ...
                return [.. resultSdJwt];
            case CredentialFormatConstants.MdocFormat:
                var resultMdoc =
                    from claim in claims
