...
using static WalletFramework.Oid4Vp.Models.RequestObject;
using static WalletFramework.Oid4Vp.Models.ClientIdScheme.ClientIdSchemeValue;
using static Newtonsoft.Json.JsonConvert;
using static WalletFramework.Oid4Vp.Models.AuthorizationRequest;
