...
using static WalletFramework.Oid4Vp.RelyingPartyAuthentication.RegistrationCertificate.RegistrationCertificateFun;

namespace WalletFramework.Oid4Vp.RelyingPartyAuthentication.RegistrationCertificate;
